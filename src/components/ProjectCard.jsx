    ...
    <>
      ...
      <Modal size='lg' show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <div className="mt-3">
            <a href={project?.github} target='_blank'className='btn me-3'><i style={{height:'50px',color:'black'}} class="fa-brands fa-github fa-2x"></i></a>

            <a href={project?.website} target='_blank'className='btn me-3'><i style={{height:'50px',color:'black'}} class="fa-solid fa-link fa-2x"></i></a>
          </div>
        </Modal.Body>
      </Modal>
    </>
